...
class MSL3(QWidget):
    def __init__(self):
        ...
        self.MSL3Title.setText(self.tr("导入 MSL 的服务器"))
        self.MSL3ImportTitle.setText(self.tr("1. 选择MSL文件夹中的ServerList.json"))
        self.MSL3ImportStatusText.setText(self.tr("[状态文本]"))
        self.MSL3ImportArchives.setText(self.tr("选择配置文件"))
        self.MSL3SelectServerStatusText.setText(self.tr("[状态文本]"))
        self.MSL3SelectServerTitle.setText(self.tr("2.选择需要导入的服务器"))
        self.MSL3ValidateArgsJavaListPushBtn.setText(self.tr("Java列表"))
        self.MSL3ValidateArgsAutoDetectJavaPrimaryPushBtn.setText(self.tr("自动查找Java"))
        self.MSL3ValidateArgsManuallyAddJavaPrimaryPushBtn.setText(self.tr("手动导入"))
        self.MSL3ValidateArgsDownloadJavaPrimaryPushBtn.setText(self.tr("下载Java"))
        self.MSL3ValidateArgsJavaSubtitleLabel.setText(self.tr("Java:"))
        self.MSL3ValidateArgsOutputDeEncodingLabel.setText(self.tr("控制台输出编码（优先级高于全局设置）"))
        self.MSL3ValidateArgsDeEncodingSubtitleLabel.setText(self.tr("编码设置："))
        self.MSL3ValidateArgsInputDeEncodingLabel.setText(self.tr("指令输入编码（优先级高于全局设置）"))
        self.MSL3ValidateArgsJVMArgPlainTextEdit.setPlaceholderText(self.tr("可选，用一个空格分组"))
        self.MSL3ValidateArgsJVMArgSubtitleLabel.setText(self.tr("JVM参数："))
        self.MSL3ValidateArgsDownloadCorePrimaryPushBtn.setText(self.tr("下载核心"))
        self.MSL3ValidateArgsCoreSubtitleLabel.setText(self.tr("核心："))
        self.MSL3ValidateArgsManuallyAddCorePrimaryPushBtn.setText(self.tr("重新导入"))
        self.MSL3ValidateArgsMemSubtitleLabel.setText(self.tr("内存:"))
        self.MSL3ValidateArgsToSymbol.setText(self.tr("~"))
        self.MSL3ValidateArgsTitle.setText(self.tr("3. 确认参数"))
        self.MSL3SaveTitle.setText(self.tr("4. 完成导入"))
        self.MSL3SaveServerNameLineEdit.setPlaceholderText(self.tr("设置服务器昵称，不能包含非法字符"))
        self.MSL3SaveServerPrimaryPushBtn.setText(self.tr("导入！"))
