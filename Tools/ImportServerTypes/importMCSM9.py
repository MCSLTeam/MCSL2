...
class MCSM9(QWidget):
    def __init__(self):
        ...
        self.MCSM9ImportTitle.setText(self.tr("1. 选择 MCSM9守护进程运行目录daemon"))
        self.MCSM9ImportStatusText.setText(self.tr("[状态文本]"))
        self.MCSM9ImportArchives.setText(self.tr("选择文件夹"))
        self.MCSM9SelectServerStatusText.setText(self.tr("[状态文本]"))
        self.MCSM9SelectServerTitle.setText(self.tr("2.选择需要导入的服务器"))
        self.MCSM9ValidateArgsJavaListPushBtn.setText(self.tr("Java列表"))
        self.MCSM9ValidateArgsAutoDetectJavaPrimaryPushBtn.setText(self.tr("自动查找Java"))
        self.MCSM9ValidateArgsManuallyAddJavaPrimaryPushBtn.setText(self.tr("手动导入"))
        self.MCSM9ValidateArgsDownloadJavaPrimaryPushBtn.setText(self.tr("下载Java"))
        self.MCSM9ValidateArgsJavaSubtitleLabel.setText(self.tr("Java:"))
        self.MCSM9ValidateArgsOutputDeEncodingLabel.setText(self.tr("控制台输出编码（优先级高于全局设置）"))
        self.MCSM9ValidateArgsDeEncodingSubtitleLabel.setText(self.tr("编码设置："))
        self.MCSM9ValidateArgsInputDeEncodingLabel.setText(self.tr("指令输入编码（优先级高于全局设置）"))
        self.MCSM9ValidateArgsJVMArgPlainTextEdit.setPlaceholderText(self.tr("可选，用一个空格分组"))
        self.MCSM9ValidateArgsJVMArgSubtitleLabel.setText(self.tr("JVM参数："))
        self.MCSM9ValidateArgsDownloadCorePrimaryPushBtn.setText(self.tr("下载核心"))
        self.MCSM9ValidateArgsCoreSubtitleLabel.setText(self.tr("核心："))
        self.MCSM9ValidateArgsManuallyAddCorePrimaryPushBtn.setText(self.tr("重新导入"))
        self.MCSM9ValidateArgsMemSubtitleLabel.setText(self.tr("内存:"))
        self.MCSM9ValidateArgsToSymbol.setText(self.tr("~"))
        self.MCSM9ValidateArgsTitle.setText(self.tr("3. 确认参数"))
        self.MCSM9SaveTitle.setText(self.tr("4. 完成导入"))
        self.MCSM9SaveServerNameLineEdit.setPlaceholderText(self.tr("设置服务器昵称，不能包含非法字符"))
        self.MCSM9SaveServerPrimaryPushBtn.setText(self.tr("导入！"))
        self.MCSM9Title.setText(self.tr("导入 MCSManager 9 的服务器"))
