...
class NoShellArchives(QWidget):
    def __init__(self):
        ...
        self.noShellArchivesScrollArea = MySmoothScrollArea(self)
        ...
        self.noShellArchivesTitle.setText(self.tr("导入 不含开服脚本的 完整的 服务器 压缩包/文件夹"))
        self.noShellArchivesImportStatusText.setText(self.tr("[状态文本]"))
        self.noShellArchivesImportArchives.setText(self.tr("导入文件"))
        self.noShellArchivesImportFolder.setText(self.tr("导入文件夹"))
        self.noShellArchivesImportTitle.setText(self.tr("1. 导入文件/文件夹"))
        self.noShellArchivesSelectCoreStatusText.setText(self.tr("[状态文本]"))
        self.noShellArchivesSelectCoreTitle.setText(self.tr("2.选择核心"))
        self.noShellArchivesJVMArgPlainTextEdit.setPlaceholderText(self.tr("可选，用一个空格分组"))
        self.noShellArchivesJVMArgSubtitleLabel.setText(self.tr("JVM参数："))
        self.noShellArchivesSetArgsTitle.setText(self.tr("3. 设置参数"))
        self.noShellArchivesDownloadJavaPrimaryPushBtn.setText(self.tr("下载Java"))
        self.noShellArchivesManuallyAddJavaPrimaryPushBtn.setText(self.tr("手动导入"))
        self.noShellArchivesAutoDetectJavaPrimaryPushBtn.setText(self.tr("自动查找Java"))
        self.noShellArchivesJavaListPushBtn.setText(self.tr("Java列表"))
        self.noShellArchivesJavaInfoLabel.setText(self.tr("[选择的Java的信息]"))
        self.noShellArchivesJavaSubtitleLabel.setText(self.tr("Java:"))
        self.noShellArchivesOutputDeEncodingLabel.setText(self.tr("控制台输出编码（优先级高于全局设置）"))
        self.noShellArchivesDeEncodingSubtitleLabel.setText(self.tr("编码设置："))
        self.noShellArchivesInputDeEncodingLabel.setText(self.tr("指令输入编码（优先级高于全局设置）"))
        self.noShellArchivesMemSubtitleLabel.setText(self.tr("内存:"))
        self.noShellArchivesToSymbol.setText(self.tr("~"))
        self.noShellArchivesSaveTitle.setText(self.tr("4. 完成导入"))
        self.noShellArchivesSaveServerNameLineEdit.setPlaceholderText(
            self.tr("设置服务器昵称，不能包含非法字符")
        )
        self.noShellArchivesSaveSaveServerPrimaryPushBtn.setText(self.tr("导入！"))
