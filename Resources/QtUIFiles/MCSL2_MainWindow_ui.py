...
# Form implementation generated from reading ui file 'e:\MCSLCode\MCSL2\Resources\QtUIFiles\MCSL2_MainWindow.ui'
#
...
class Ui_MCSL2_MainWindow(object):
    def setupUi(self, MCSL2_MainWindow):
        ...
        sizePolicy.setHeightForWidth(
            MCSL2_MainWindow.sizePolicy().hasHeightForWidth())
        ...
        self.Home_Page_PushButton.setCursor(
        ...
        self.Config_Page_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Download_Page_PushButton = QtWidgets.QPushButton(
            self.OptionsWidget)
        self.Download_Page_PushButton.setEnabled(True)
        self.Download_Page_PushButton.setGeometry(
            QtCore.QRect(20, 260, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(13)
        self.Download_Page_PushButton.setFont(font)
        self.Download_Page_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Tools_Page_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.About_Page_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Blue1.setGeometry(QtCore.QRect(20, 150, 3, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.Blue2.setGeometry(QtCore.QRect(20, 210, 3, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.Blue3.setGeometry(QtCore.QRect(20, 270, 3, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.Blue4.setGeometry(QtCore.QRect(20, 330, 3, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.Blue5.setGeometry(QtCore.QRect(20, 390, 3, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.Blue6.setGeometry(QtCore.QRect(20, 450, 3, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.TitleBarWidget.setGeometry(QtCore.QRect(20, 20, 171, 111))
        self.TitleBarWidget.setObjectName("TitleBarWidget")
        self.MCSL2_Title_Label = QtWidgets.QLabel(self.TitleBarWidget)
        self.MCSL2_Title_Label.setGeometry(QtCore.QRect(80, 50, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(14)
        self.MCSL2_Title_Label.setFont(font)
        self.MCSL2_Title_Label.setObjectName("MCSL2_Title_Label")
        self.Close_PushButton = QtWidgets.QPushButton(self.TitleBarWidget)
        self.Close_PushButton.setGeometry(QtCore.QRect(0, 0, 22, 22))
        self.Close_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Minimize_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.MCSL2_Title_Icon_Label.setGeometry(QtCore.QRect(0, 30, 71, 71))
        ...
        self.FunctionsStackedWidget = QtWidgets.QStackedWidget(
            self.CentralWidget)
        self.FunctionsStackedWidget.setGeometry(
            QtCore.QRect(220, -10, 731, 601))
        ...
        self.Notice_Label.setTextFormat(QtCore.Qt.PlainText)
        ...
        self.HomePageButtons_Widget.setGeometry(
            QtCore.QRect(470, 410, 251, 181))
        self.HomePageButtons_Widget.setObjectName("HomePageButtons_Widget")
        self.Selected_Server_Label = QtWidgets.QLabel(
            self.HomePageButtons_Widget)
        ...
        self.Start_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Config_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Choose_Server_PushButton = QtWidgets.QPushButton(
            self.HomePageButtons_Widget)
        self.Choose_Server_PushButton.setGeometry(
            QtCore.QRect(10, 10, 111, 51))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(14)
        self.Choose_Server_PushButton.setFont(font)
        self.Choose_Server_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ConfigModeWidget = QtWidgets.QStackedWidget(self.ConfigPage)
        self.ConfigModeWidget.setGeometry(QtCore.QRect(30, 140, 670, 451))
        self.ConfigModeWidget.setFrameShadow(QtWidgets.QFrame.Plain)
        self.ConfigModeWidget.setLineWidth(1)
        self.ConfigModeWidget.setObjectName("ConfigModeWidget")
        self.LeadCPage = QtWidgets.QWidget()
        self.LeadCPage.setObjectName("LeadCPage")
        self.LeadConfigTip1 = QtWidgets.QLabel(self.LeadCPage)
        self.LeadConfigTip1.setGeometry(QtCore.QRect(215, 100, 240, 40))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.NoobAddServer = QtWidgets.QCommandLinkButton(self.LeadCPage)
        self.NoobAddServer.setGeometry(QtCore.QRect(30, 210, 190, 50))
        self.NoobAddServer.setMinimumSize(QtCore.QSize(190, 50))
        self.NoobAddServer.setMaximumSize(QtCore.QSize(190, 50))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(-1)
        font.setBold(False)
        ...
        self.NoobAddServer.setStyleSheet("QPushButton\n"
                                         ...
                                         "}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/QuickStart.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/QuickStart.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon1.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/QuickStart.svg"),
        ...
        self.NoobAddServer.setIconSize(QtCore.QSize(30, 30))
        ...
        self.ExAddServer = QtWidgets.QCommandLinkButton(self.LeadCPage)
        self.ExAddServer.setGeometry(QtCore.QRect(240, 210, 190, 50))
        self.ExAddServer.setMinimumSize(QtCore.QSize(190, 50))
        self.ExAddServer.setMaximumSize(QtCore.QSize(190, 50))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(-1)
        font.setBold(False)
        ...
        self.ExAddServer.setStyleSheet("QPushButton\n"
                                       ...
                                       "}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/Add.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/Add.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon2.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/Add.svg"),
        ...
        self.ExAddServer.setIconSize(QtCore.QSize(30, 30))
        ...
        self.ImportServer = QtWidgets.QCommandLinkButton(self.LeadCPage)
        self.ImportServer.setGeometry(QtCore.QRect(450, 210, 190, 50))
        self.ImportServer.setMinimumSize(QtCore.QSize(190, 50))
        self.ImportServer.setMaximumSize(QtCore.QSize(190, 50))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(-1)
        font.setBold(False)
        ...
        self.ImportServer.setStyleSheet("QPushButton\n"
                                        ...
                                        "}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/Import.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/Import.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap(":/MCSL2_Icon/Import.svg"),
        ...
        self.ImportServer.setIconSize(QtCore.QSize(30, 30))
        ...
        self.LeadConfigTip2 = QtWidgets.QLabel(self.LeadCPage)
        self.LeadConfigTip2.setGeometry(QtCore.QRect(60, 260, 131, 141))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.LeadConfigTip2.setAlignment(
        ...
        self.LeadConfigTip2_2.setAlignment(
            QtCore.Qt.AlignJustify | QtCore.Qt.AlignVCenter)
        ...
        self.LeadConfigTip2_3.setAlignment(
            QtCore.Qt.AlignJustify | QtCore.Qt.AlignVCenter)
        ...
        self.Completed_Save_PushButton = QtWidgets.QPushButton(self.NoobCPage)
        self.Completed_Save_PushButton.setGeometry(
            QtCore.QRect(20, 330, 211, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.Completed_Save_PushButton.setFont(font)
        self.Completed_Save_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Server_Name_Label.setGeometry(QtCore.QRect(20, 280, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.Server_Name_Label.setFont(font)
        self.Server_Name_Label.setObjectName("Server_Name_Label")
        self.Server_Name_LineEdit = QtWidgets.QLineEdit(self.NoobCPage)
        self.Server_Name_LineEdit.setGeometry(QtCore.QRect(120, 290, 111, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.Configuration_Widget.setGeometry(QtCore.QRect(280, 0, 351, 291))
        self.Configuration_Widget.setObjectName("Configuration_Widget")
        self.Download_Core_PushButton = QtWidgets.QPushButton(
            self.Configuration_Widget)
        self.Download_Core_PushButton.setGeometry(
            QtCore.QRect(230, 240, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.Download_Core_PushButton.setFont(font)
        self.Download_Core_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Download_Java_PushButton = QtWidgets.QPushButton(
            self.Configuration_Widget)
        self.Download_Java_PushButton.setGeometry(
            QtCore.QRect(130, 70, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.Download_Java_PushButton.setFont(font)
        self.Download_Java_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Manual_Import_Core_PushButton = QtWidgets.QPushButton(
            self.Configuration_Widget)
        self.Manual_Import_Core_PushButton.setGeometry(
            QtCore.QRect(120, 240, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.Manual_Import_Core_PushButton.setFont(font)
        self.Manual_Import_Core_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Set_Core_Background.setGeometry(QtCore.QRect(0, 220, 351, 71))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.MinMemory_LineEdit = QtWidgets.QLineEdit(
            self.Configuration_Widget)
        ...
        self.Set_Memory_Background = QtWidgets.QLabel(
            self.Configuration_Widget)
        ...
        self.MaxMemory_LineEdit = QtWidgets.QLineEdit(
            self.Configuration_Widget)
        ...
        self.Auto_Find_Java_PushButton = QtWidgets.QPushButton(
            self.Configuration_Widget)
        self.Auto_Find_Java_PushButton.setGeometry(
            QtCore.QRect(20, 70, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.Auto_Find_Java_PushButton.setFont(font)
        self.Auto_Find_Java_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Founded_Java_List_PushButton = QtWidgets.QPushButton(
            self.Configuration_Widget)
        self.Founded_Java_List_PushButton.setGeometry(
            QtCore.QRect(240, 70, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.Founded_Java_List_PushButton.setFont(font)
        self.Founded_Java_List_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ExtendedCPage = QtWidgets.QWidget()
        self.ExtendedCPage.setObjectName("ExtendedCPage")
        self.ExConfiguration_Widget = QtWidgets.QWidget(self.ExtendedCPage)
        self.ExConfiguration_Widget.setGeometry(QtCore.QRect(0, 0, 671, 451))
        self.ExConfiguration_Widget.setObjectName("ExConfiguration_Widget")
        self.ExDownload_Core_PushButton = QtWidgets.QPushButton(
            self.ExConfiguration_Widget)
        self.ExDownload_Core_PushButton.setGeometry(
            QtCore.QRect(560, 145, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.ExDownload_Core_PushButton.setFont(font)
        self.ExDownload_Core_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ExDownload_Java_PushButton = QtWidgets.QPushButton(
            self.ExConfiguration_Widget)
        self.ExDownload_Java_PushButton.setGeometry(
            QtCore.QRect(130, 70, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.ExDownload_Java_PushButton.setFont(font)
        self.ExDownload_Java_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ExManual_Import_Core_PushButton = QtWidgets.QPushButton(
            self.ExConfiguration_Widget)
        self.ExManual_Import_Core_PushButton.setGeometry(
            QtCore.QRect(450, 145, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.ExManual_Import_Core_PushButton.setFont(font)
        self.ExManual_Import_Core_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ExSet_Core_Background = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        self.ExSet_Core_Background.setGeometry(QtCore.QRect(330, 130, 341, 61))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.ExSet_Java_Background = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        self.ExSet_Java_Background.setGeometry(QtCore.QRect(0, 0, 361, 121))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.ExMemory_1_Label.setGeometry(QtCore.QRect(20, 140, 71, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.ExMemory_1_Label.setFont(font)
        self.ExMemory_1_Label.setObjectName("ExMemory_1_Label")
        self.ExMinMemory_LineEdit = QtWidgets.QLineEdit(
            self.ExConfiguration_Widget)
        self.ExMinMemory_LineEdit.setGeometry(QtCore.QRect(70, 150, 61, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.ExSet_Memory_Background = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        ...
        self.ExJava_Label.setGeometry(QtCore.QRect(20, 20, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.ExJava_Label.setFont(font)
        self.ExJava_Label.setObjectName("ExJava_Label")
        self.ExMaxMemory_LineEdit = QtWidgets.QLineEdit(
            self.ExConfiguration_Widget)
        self.ExMaxMemory_LineEdit.setGeometry(QtCore.QRect(165, 150, 61, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.ExCore_Label = QtWidgets.QLabel(self.ExConfiguration_Widget)
        self.ExCore_Label.setGeometry(QtCore.QRect(350, 145, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.ExCore_Label.setFont(font)
        self.ExCore_Label.setObjectName("ExCore_Label")
        self.ExAuto_Find_Java_PushButton = QtWidgets.QPushButton(
            self.ExConfiguration_Widget)
        self.ExAuto_Find_Java_PushButton.setGeometry(
            QtCore.QRect(20, 70, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.ExAuto_Find_Java_PushButton.setFont(font)
        self.ExAuto_Find_Java_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ExJava_Version_Label = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        self.ExJava_Version_Label.setGeometry(QtCore.QRect(80, 20, 261, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.ExFounded_Java_List_PushButton = QtWidgets.QPushButton(
            self.ExConfiguration_Widget)
        self.ExFounded_Java_List_PushButton.setGeometry(
            QtCore.QRect(240, 70, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.ExFounded_Java_List_PushButton.setFont(font)
        self.ExFounded_Java_List_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.ExFounded_Java_List_PushButton.setStyleSheet("QPushButton\n"
                                                          ...
                                                          "    border-radius: 7px;\n"
                                                          "}")
        self.ExFounded_Java_List_PushButton.setObjectName(
            "ExFounded_Java_List_PushButton")
        self.ExOthers_Background = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        ...
        self.ExServer_Name_LineEdit = QtWidgets.QLineEdit(
            self.ExConfiguration_Widget)
        self.ExServer_Name_LineEdit.setGeometry(QtCore.QRect(500, 30, 151, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.ExServer_Name_Label = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        ...
        self.ExCompleted_Save_PushButton = QtWidgets.QPushButton(
            self.ExConfiguration_Widget)
        self.ExCompleted_Save_PushButton.setGeometry(
            QtCore.QRect(400, 70, 251, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.ExCompleted_Save_PushButton.setFont(font)
        self.ExCompleted_Save_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ExMemoryUnitComboBox = QtWidgets.QComboBox(
            self.ExConfiguration_Widget)
        self.ExMemoryUnitComboBox.setGeometry(QtCore.QRect(240, 145, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.ExMemoryUnitComboBox.addItem("")
        self.ExSet_Encoding_Background = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        self.ExSet_Encoding_Background.setGeometry(
            QtCore.QRect(0, 200, 671, 111))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.ExConsoleInputDecoding = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        self.ExConsoleInputDecoding.setGeometry(QtCore.QRect(20, 263, 251, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.ExConsoleInputDecoding.setFont(font)
        self.ExConsoleInputDecoding.setObjectName("ExConsoleInputDecoding")
        self.ExConsoleOutputEncodingComboBox = QtWidgets.QComboBox(
            self.ExConfiguration_Widget)
        self.ExConsoleOutputEncodingComboBox.setGeometry(
            QtCore.QRect(390, 220, 241, 31))
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.ExConsoleOutputEncodingComboBox.sizePolicy().hasHeightForWidth())
        ...
        self.ExConsoleOutputEncodingComboBox.addItem("")
        self.ExConsoleInputDecodingComboBox = QtWidgets.QComboBox(
            self.ExConfiguration_Widget)
        self.ExConsoleInputDecodingComboBox.setGeometry(
            QtCore.QRect(390, 260, 241, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        font.setKerning(True)
        ...
        self.ExConsoleInputDecodingComboBox.setStyleSheet("QComboBox {\n"
                                                          ...
                                                          "    color: rgba(0, 0, 0, 0.7);\n"
                                                          "}")
        self.ExConsoleInputDecodingComboBox.setSizeAdjustPolicy(
        ...
        self.ExConsoleInputDecodingComboBox.addItem("")
        self.ExConsoleInputDecodingComboBox.addItem("")
        self.ExConsoleOutputEncoding = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        self.ExConsoleOutputEncoding.setGeometry(
            QtCore.QRect(20, 223, 271, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.ExConsoleOutputEncoding.setFont(font)
        self.ExConsoleOutputEncoding.setObjectName("ExConsoleOutputEncoding")
        self.ExJVMArg = QtWidgets.QLabel(self.ExConfiguration_Widget)
        self.ExJVMArg.setGeometry(QtCore.QRect(20, 330, 251, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.ExJVMArg.setFont(font)
        self.ExJVMArg.setObjectName("ExJVMArg")
        self.ExJVMArg_Background = QtWidgets.QLabel(
            self.ExConfiguration_Widget)
        self.ExJVMArg_Background.setGeometry(QtCore.QRect(0, 320, 671, 131))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.ExJVMArgLineEdit = QtWidgets.QTextEdit(
            self.ExConfiguration_Widget)
        self.ExJVMArgLineEdit.setGeometry(QtCore.QRect(20, 360, 631, 81))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.DownloadSwitcher_TabWidget = QtWidgets.QTabWidget(
            self.DownloadPage)
        self.DownloadSwitcher_TabWidget.setGeometry(
            QtCore.QRect(30, 150, 651, 411))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.DownloadSwitcher_TabWidget.setFont(font)
        self.DownloadSwitcher_TabWidget.setCursor(
        ...
        self.DownloadSwitcher_TabWidget.setStyleSheet("QTabWidget\n"
                                                      ...
                                                      "    background-color: rgb(235, 235, 235);\n"
                                                      "}")
        self.DownloadSwitcher_TabWidget.setTabPosition(
        ...
        self.JavaScrollArea.viewport().setProperty(
        ...
        self.JavaScrollArea.setVerticalScrollBarPolicy(
            QtCore.Qt.ScrollBarAlwaysOn)
        self.JavaScrollArea.setHorizontalScrollBarPolicy(
        ...
        self.SpigotScrollArea.viewport().setProperty(
            "cursor", QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.SpigotScrollArea.setVerticalScrollBarPolicy(
            QtCore.Qt.ScrollBarAlwaysOn)
        ...
        self.PaperScrollArea.viewport().setProperty(
            "cursor", QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.PaperScrollArea.setVerticalScrollBarPolicy(
            QtCore.Qt.ScrollBarAlwaysOn)
        ...
        self.PaperScrollAreaWidgetContents.setGeometry(
            QtCore.QRect(0, 0, 619, 351))
        ...
        self.OfficialCoreScrollArea = QtWidgets.QScrollArea(
            self.OfficialCoreTab)
        ...
        self.More_Download_PushButton = QtWidgets.QPushButton(
            self.DownloadPage)
        self.More_Download_PushButton.setGeometry(
            QtCore.QRect(610, 100, 71, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.GoToDownloadSourceChangerPushButton = QtWidgets.QPushButton(
            self.DownloadPage)
        self.GoToDownloadSourceChangerPushButton.setGeometry(
            QtCore.QRect(500, 100, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.GoToDownloadSourceChangerPushButton.setFont(font)
        self.GoToDownloadSourceChangerPushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.CurrentDownloadSourceLabel.setGeometry(
            QtCore.QRect(100, 90, 281, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.Send_Command_PushButton.setGeometry(
            QtCore.QRect(570, 480, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.Send_Command_PushButton.setFont(font)
        self.Send_Command_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ToolsScrollArea.viewport().setProperty(
            "cursor", QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.ToolsScrollArea.setVerticalScrollBarPolicy(
            QtCore.Qt.ScrollBarAlwaysOn)
        ...
        self.ToolsScrollAreaWidgetContents = QtWidgets.QWidget()
        self.ToolsScrollAreaWidgetContents.setGeometry(
            QtCore.QRect(0, 0, 649, 411))
        self.ToolsScrollAreaWidgetContents.setObjectName(
            "ToolsScrollAreaWidgetContents")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(
            self.ToolsScrollAreaWidgetContents)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.ToolsVerticalLayout = QtWidgets.QVBoxLayout()
        ...
        self.GoToChangeToolsConfigPushButton = QtWidgets.QPushButton(
            self.ToolsPage)
        self.GoToChangeToolsConfigPushButton.setGeometry(
            QtCore.QRect(620, 90, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.GoToChangeToolsConfigPushButton.setFont(font)
        self.GoToChangeToolsConfigPushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.InstallToolsPushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.SettingsScrollArea.viewport().setProperty(
            "cursor", QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.ServerSettingsWidget = QtWidgets.QWidget(
            self.SettingsScrollAreaWidgetContents)
        ...
        self.AutoRunLastServerSetting = QtWidgets.QCheckBox(
            self.ServerSettingsWidget)
        self.AutoRunLastServerSetting.setGeometry(
            QtCore.QRect(30, 50, 410, 30))
        ...
        self.AcceptAllMojangEULASetting = QtWidgets.QCheckBox(
            self.ServerSettingsWidget)
        self.AcceptAllMojangEULASetting.setGeometry(
            QtCore.QRect(30, 80, 410, 30))
        ...
        self.StopServerSettings = QtWidgets.QCheckBox(
            self.ServerSettingsWidget)
        ...
        self.ServerSettingsWidgetTitleLabel = QtWidgets.QLabel(
            self.ServerSettingsTitle)
        self.ServerSettingsWidgetTitleLabel.setGeometry(
            QtCore.QRect(30, 10, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.ServerSettingsWidgetBlue = QtWidgets.QLabel(
            self.ServerSettingsTitle)
        ...
        self.ServerSettingsWidgetBlue.setCursor(
            QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.ConfigPageSettingsWidget = QtWidgets.QWidget(
            self.SettingsScrollAreaWidgetContents)
        ...
        self.OnlySaveGlobalServerConfigs = QtWidgets.QCheckBox(
            self.ConfigPageSettingsWidget)
        self.OnlySaveGlobalServerConfigs.setGeometry(
            QtCore.QRect(30, 93, 410, 30))
        ...
        self.ConfigPageSettingsTitle = QtWidgets.QWidget(
            self.ConfigPageSettingsWidget)
        ...
        self.ConfigPageSettingsWidgetTitleLabel = QtWidgets.QLabel(
        ...
        self.ConfigPageSettingsWidgetBlue = QtWidgets.QLabel(
            self.ConfigPageSettingsTitle)
        self.ConfigPageSettingsWidgetBlue.setGeometry(
            QtCore.QRect(10, 10, 10, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.ConfigPageSettingsWidgetBlue.setFont(font)
        self.ConfigPageSettingsWidgetBlue.setCursor(
            QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.HowToAddServerComboBox = QtWidgets.QComboBox(
            self.ConfigPageSettingsWidget)
        ...
        self.DownloadSettingsWidget = QtWidgets.QWidget(
            self.SettingsScrollAreaWidgetContents)
        ...
        self.DownloadSettingsTitle = QtWidgets.QWidget(
        ...
        self.DownloadSettingsWidgetTitleLabel = QtWidgets.QLabel(
        ...
        self.DownloadSettingsWidgetBlue = QtWidgets.QLabel(
            self.DownloadSettingsTitle)
        self.DownloadSettingsWidgetBlue.setGeometry(
            QtCore.QRect(10, 10, 10, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.DownloadSettingsWidgetBlue.setFont(font)
        self.DownloadSettingsWidgetBlue.setCursor(
            QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.MCSLAPIDownloadSource = QtWidgets.QLabel(
            self.DownloadSettingsWidget)
        ...
        self.MCSLAPIDownloadSourceComboBox = QtWidgets.QComboBox(
            self.DownloadSettingsWidget)
        self.MCSLAPIDownloadSourceComboBox.setGeometry(
            QtCore.QRect(350, 60, 241, 31))
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.MCSLAPIDownloadSourceComboBox.sizePolicy().hasHeightForWidth())
        ...
        self.Aria2ThreadCountComboBox = QtWidgets.QComboBox(
            self.DownloadSettingsWidget)
        self.Aria2ThreadCountComboBox.setGeometry(
            QtCore.QRect(490, 100, 101, 35))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(-1)
        font.setBold(False)
        ...
        self.Aria2ThreadCountComboBox.setSizeAdjustPolicy(
            QtWidgets.QComboBox.AdjustToMinimumContentsLength)
        ...
        self.Aria2ThreadCountComboBox.addItem("")
        self.Aria2ThreadCountComboBox.addItem("")
        self.AlwaysAskDownloadPath = QtWidgets.QCheckBox(
            self.DownloadSettingsWidget)
        ...
        self.AlwaysAskDownloadPathTip = QtWidgets.QLabel(
            self.DownloadSettingsWidget)
        self.AlwaysAskDownloadPathTip.setGeometry(
            QtCore.QRect(60, 170, 451, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.SameFileExceptionStop = QtWidgets.QRadioButton(
            self.DownloadSettingsWidget)
        ...
        self.SameFileExceptionAsk = QtWidgets.QRadioButton(
            self.DownloadSettingsWidget)
        ...
        self.SameFileExceptionReWrite = QtWidgets.QRadioButton(
            self.DownloadSettingsWidget)
        self.SameFileExceptionReWrite.setGeometry(
            QtCore.QRect(430, 200, 71, 24))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.ConsoleSettingsWidget = QtWidgets.QWidget(
            self.SettingsScrollAreaWidgetContents)
        ...
        self.ConsoleSettingsTitle = QtWidgets.QWidget(
        ...
        self.ConsoleSettingsWidgetTitleLabel = QtWidgets.QLabel(
            self.ConsoleSettingsTitle)
        self.ConsoleSettingsWidgetTitleLabel.setGeometry(
            QtCore.QRect(30, 10, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.ConsoleSettingsWidgetBlue = QtWidgets.QLabel(
            self.ConsoleSettingsTitle)
        self.ConsoleSettingsWidgetBlue.setGeometry(
            QtCore.QRect(10, 10, 10, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.ConsoleSettingsWidgetBlue.setFont(font)
        self.ConsoleSettingsWidgetBlue.setCursor(
            QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.ConsoleOutputEncoding = QtWidgets.QLabel(
            self.ConsoleSettingsWidget)
        ...
        self.ConsoleOutputEncodingComboBox = QtWidgets.QComboBox(
            self.ConsoleSettingsWidget)
        self.ConsoleOutputEncodingComboBox.setGeometry(
            QtCore.QRect(350, 100, 241, 31))
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.ConsoleOutputEncodingComboBox.sizePolicy().hasHeightForWidth())
        ...
        self.ConsoleOutputEncodingComboBox.addItem("")
        self.ConsoleInputDecoding = QtWidgets.QLabel(
            self.ConsoleSettingsWidget)
        ...
        self.ConsoleInputDecodingComboBox = QtWidgets.QComboBox(
            self.ConsoleSettingsWidget)
        self.ConsoleInputDecodingComboBox.setGeometry(
            QtCore.QRect(350, 140, 241, 35))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(-1)
        font.setBold(False)
        ...
        self.ConsoleInputDecodingComboBox.setSizeAdjustPolicy(
            QtWidgets.QComboBox.AdjustToMinimumContentsLength)
        ...
        self.UISettingsWidget = QtWidgets.QWidget(
            self.SettingsScrollAreaWidgetContents)
        ...
        self.UISettingsWidgetTitleLabel = QtWidgets.QLabel(
            self.UISettingsTitle)
        self.UISettingsWidgetTitleLabel.setGeometry(
            QtCore.QRect(30, 10, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.UISettingsWidgetBlue.setCursor(
            QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.DarkModeComboBox.setSizeAdjustPolicy(
            QtWidgets.QComboBox.AdjustToMinimumContentsLength)
        ...
        self.DarkModeComboBox.addItem("")
        self.DarkModeComboBox.addItem("")
        self.TitleBarInsteadOfmacOS = QtWidgets.QCheckBox(
            self.UISettingsWidget)
        self.TitleBarInsteadOfmacOS.setGeometry(QtCore.QRect(30, 100, 261, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.TransparentPercentSlider = QtWidgets.QSlider(
            self.UISettingsWidget)
        self.TransparentPercentSlider.setGeometry(
            QtCore.QRect(370, 70, 181, 24))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.TransparentPercentSlider.setTickPosition(
            QtWidgets.QSlider.NoTicks)
        ...
        self.TransparentPercentNum.setGeometry(QtCore.QRect(560, 60, 40, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.SoftwareSettingsWidget = QtWidgets.QWidget(
            self.SettingsScrollAreaWidgetContents)
        ...
        self.AlwaysRunAsAdministrator = QtWidgets.QCheckBox(
            self.SoftwareSettingsWidget)
        self.AlwaysRunAsAdministrator.setGeometry(
            QtCore.QRect(30, 93, 410, 30))
        ...
        self.SoftwareSettingsTitle = QtWidgets.QWidget(
            self.SoftwareSettingsWidget)
        ...
        self.SoftwareSettingsWidgetTitleLabel = QtWidgets.QLabel(
        ...
        self.SoftwareSettingsWidgetBlue = QtWidgets.QLabel(
            self.SoftwareSettingsTitle)
        self.SoftwareSettingsWidgetBlue.setGeometry(
            QtCore.QRect(10, 10, 10, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        self.SoftwareSettingsWidgetBlue.setFont(font)
        self.SoftwareSettingsWidgetBlue.setCursor(
            QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.UpdaterWidget = QtWidgets.QWidget(
            self.SettingsScrollAreaWidgetContents)
        ...
        self.UpdatePushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.OpenSourceCodePushButton.setGeometry(
            QtCore.QRect(30, 280, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.OpenSourceCodePushButton.setFont(font)
        self.OpenSourceCodePushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.MCSL2_Icon_Label.setPixmap(
            QtGui.QPixmap(":/MCSL2_Icon/MCSL2_Icon.png"))
        ...
        self.MCSL2_Author_Avatar.setPixmap(
            QtGui.QPixmap(":/MCSL2_Icon/MCSL2_Author.png"))
        ...
        self.SystemReportPushButton.setGeometry(
            QtCore.QRect(290, 280, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.SystemReportPushButton.setFont(font)
        self.SystemReportPushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.ChooseServerScrollArea = QtWidgets.QScrollArea(
            self.ChooseServerPage)
        self.ChooseServerScrollArea.setGeometry(
            QtCore.QRect(30, 140, 641, 401))
        ...
        self.ChooseServerScrollAreaVerticalLayout = QtWidgets.QVBoxLayout()
        ...
        self.Choose_Java_Back_PushButton = QtWidgets.QPushButton(
            self.ChooseJavaPage)
        self.Choose_Java_Back_PushButton.setGeometry(
            QtCore.QRect(200, 90, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(14)
        ...
        self.DoNotUpdate_PushButton.setGeometry(
            QtCore.QRect(340, 490, 101, 61))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(14)
        ...
        self.Update_PushButton.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Update_Introduction_Widget.setGeometry(
            QtCore.QRect(30, 230, 651, 221))
        ...
        self.Update_Introduction_LabelScrollAreascrollArea = QtWidgets.QScrollArea(
            self.Update_Introduction_Widget)
        self.Update_Introduction_LabelScrollAreascrollArea.setGeometry(
            QtCore.QRect(20, 60, 621, 151))
        sizePolicy = QtWidgets.QSizePolicy(
        ...
        self.Update_Introduction_Label.setMaximumSize(
            QtCore.QSize(600, 16777215))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.Minimize_PushButton_R = QtWidgets.QPushButton(
            self.TitleBarWidget_R)
        self.Minimize_PushButton_R.setGeometry(QtCore.QRect(870, 10, 22, 22))
        self.Minimize_PushButton_R.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.Close_PushButton_R.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.MCSL2_Title_Label_R.setGeometry(QtCore.QRect(60, 10, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MCSL2_MainWindow):
        ...
        MCSL2_MainWindow.setWindowTitle(
            _translate("MCSL2_MainWindow", "MCSL 2"))
        self.Home_Page_PushButton.setText(
            _translate("MCSL2_MainWindow", "  主页"))
        self.Config_Page_PushButton.setText(
            _translate("MCSL2_MainWindow", "  配置"))
        self.Download_Page_PushButton.setText(
            _translate("MCSL2_MainWindow", "  下载"))
        self.Server_Console_Page_PushButton.setText(
            _translate("MCSL2_MainWindow", "  终端"))
        self.Tools_Page_PushButton.setText(
            _translate("MCSL2_MainWindow", "  插件"))
        self.About_Page_PushButton.setText(
            _translate("MCSL2_MainWindow", "  更多"))
        self.MCSL2_Title_Label.setText(
            _translate("MCSL2_MainWindow", "MCSL 2"))
        ...
        self.Selected_Server_Label.setText(
            _translate("MCSL2_MainWindow", "未选择服务器！"))
        ...
        self.Choose_Server_PushButton.setText(
            _translate("MCSL2_MainWindow", "选择"))
        self.Config_Label.setText(_translate("MCSL2_MainWindow", "配置服务器"))
        self.LeadConfigTip1.setText(_translate(
            "MCSL2_MainWindow", "请选择您想要添加服务器的方式："))
        ...
        self.LeadConfigTip2_3.setText(
            _translate("MCSL2_MainWindow", "  （未开发完成）"))
        self.Completed_Save_PushButton.setText(
            _translate("MCSL2_MainWindow", "保存"))
        self.Server_Name_Label.setText(
            _translate("MCSL2_MainWindow", "服务器名称："))
        self.Download_Core_PushButton.setText(
            _translate("MCSL2_MainWindow", "下载核心"))
        self.Download_Java_PushButton.setText(
            _translate("MCSL2_MainWindow", "下载Java"))
        ...
        self.Auto_Find_Java_PushButton.setText(
            _translate("MCSL2_MainWindow", "自动查找"))
        ...
        self.ExAuto_Find_Java_PushButton.setText(
            _translate("MCSL2_MainWindow", "自动查找"))
        self.ExFounded_Java_List_PushButton.setText(
            _translate("MCSL2_MainWindow", "Java列表"))
        self.ExServer_Name_Label.setText(
            _translate("MCSL2_MainWindow", "服务器名称："))
        self.ExCompleted_Save_PushButton.setText(
            _translate("MCSL2_MainWindow", "保存"))
        self.ExMemoryUnitComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "M"))
        self.ExMemoryUnitComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "G"))
        self.ExConsoleInputDecoding.setText(
            _translate("MCSL2_MainWindow", "发送指令编码(优先级高于全局设置）"))
        self.ExConsoleOutputEncodingComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "UTF-8（默认）"))
        self.ExConsoleOutputEncodingComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "GBK（乱码可尝试）"))
        self.ExConsoleInputDecodingComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "与输出相同"))
        self.ExConsoleInputDecodingComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "UTF-8"))
        self.ExConsoleInputDecodingComboBox.setItemText(
            2, _translate("MCSL2_MainWindow", "GBK"))
        self.ExConsoleOutputEncoding.setText(
            _translate("MCSL2_MainWindow", "控制台输出编码(优先级高于全局设置）"))
        ...
        self.DownloadSwitcher_TabWidget.setTabText(self.DownloadSwitcher_TabWidget.indexOf(
            self.JavaTab), _translate("MCSL2_MainWindow", "Java"))
        self.DownloadSwitcher_TabWidget.setTabText(self.DownloadSwitcher_TabWidget.indexOf(
            self.SpigotTab), _translate("MCSL2_MainWindow", "Spigot"))
        self.DownloadSwitcher_TabWidget.setTabText(self.DownloadSwitcher_TabWidget.indexOf(
            self.PaperTab), _translate("MCSL2_MainWindow", "Paper"))
        self.DownloadSwitcher_TabWidget.setTabText(self.DownloadSwitcher_TabWidget.indexOf(
            self.BungeeCordTab), _translate("MCSL2_MainWindow", "BungeeCord"))
        self.DownloadSwitcher_TabWidget.setTabText(self.DownloadSwitcher_TabWidget.indexOf(
            self.OfficialCoreTab), _translate("MCSL2_MainWindow", "官方"))
        self.More_Download_PushButton.setText(
            _translate("MCSL2_MainWindow", "更多"))
        self.GoToDownloadSourceChangerPushButton.setText(
            _translate("MCSL2_MainWindow", "下载源设置"))
        self.CurrentDownloadSourceLabel.setText(
            _translate("MCSL2_MainWindow", "当前下载源："))
        ...
        self.Send_Command_PushButton.setText(
            _translate("MCSL2_MainWindow", "发送"))
        self.Tools_Label.setText(_translate("MCSL2_MainWindow", "插件"))
        self.GoToChangeToolsConfigPushButton.setText(
            _translate("MCSL2_MainWindow", "插件设置"))
        self.InstallToolsPushButton.setText(
            _translate("MCSL2_MainWindow", "安装插件"))
        self.About_Label.setText(_translate("MCSL2_MainWindow", "更多"))
        self.AutoRunLastServerSetting.setText(
            _translate("MCSL2_MainWindow", "开启MCSL2时自动运行上次运行的服务器"))
        self.AcceptAllMojangEULASetting.setText(
            _translate("MCSL2_MainWindow", "同意所有新添加服务器的Mojang EULA"))
        self.StopServerSettings.setText(_translate(
            "MCSL2_MainWindow", "关闭服务器时向服务器发送 stop 指令而不是结束进程"))
        self.ServerSettingsWidgetTitleLabel.setText(
            _translate("MCSL2_MainWindow", "服务器设置"))
        self.OnlySaveGlobalServerConfigs.setText(
            _translate("MCSL2_MainWindow", "仅保存全局服务器设置"))
        self.ConfigPageSettingsWidgetTitleLabel.setText(
            _translate("MCSL2_MainWindow", "配置页设置"))
        self.HowToAddServer.setText(
            _translate("MCSL2_MainWindow", "添加服务器引导方式"))
        self.HowToAddServerComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "初始 (新手+进阶)"))
        self.HowToAddServerComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "总是新手"))
        self.HowToAddServerComboBox.setItemText(
            2, _translate("MCSL2_MainWindow", "总是进阶"))
        self.DownloadSettingsWidgetTitleLabel.setText(
            _translate("MCSL2_MainWindow", "下载设置"))
        self.MCSLAPIDownloadSource.setText(
            _translate("MCSL2_MainWindow", "MCSLAPI下载源选择"))
        self.MCSLAPIDownloadSourceComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "国内SharePoint"))
        self.MCSLAPIDownloadSourceComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "Gitee"))
        self.MCSLAPIDownloadSourceComboBox.setItemText(
            2, _translate("MCSL2_MainWindow", "luoxis云（暂不可用）"))
        self.MCSLAPIDownloadSourceComboBox.setItemText(
            3, _translate("MCSL2_MainWindow", "GHProxy"))
        self.MCSLAPIDownloadSourceComboBox.setItemText(
            4, _translate("MCSL2_MainWindow", "GitHub"))
        self.Aria2ThreadCount.setText(
            _translate("MCSL2_MainWindow", "Aria2引擎线程数"))
        self.Aria2ThreadCountComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "1"))
        self.Aria2ThreadCountComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "2"))
        self.Aria2ThreadCountComboBox.setItemText(
            2, _translate("MCSL2_MainWindow", "4"))
        self.Aria2ThreadCountComboBox.setItemText(
            3, _translate("MCSL2_MainWindow", "8"))
        self.Aria2ThreadCountComboBox.setItemText(
            4, _translate("MCSL2_MainWindow", "16"))
        self.AlwaysAskDownloadPath.setText(
            _translate("MCSL2_MainWindow", "总是询问下载保存位置"))
        self.AlwaysAskDownloadPathTip.setText(_translate(
            "MCSL2_MainWindow", "若不勾选，则会保存至MCSL2/Downloads文件夹。"))
        self.SameFileException.setText(_translate(
            "MCSL2_MainWindow", "下载保存位置存在同名文件处理"))
        self.SameFileExceptionStop.setText(
            _translate("MCSL2_MainWindow", "停止"))
        self.SameFileExceptionAsk.setText(_translate("MCSL2_MainWindow", "询问"))
        self.SameFileExceptionReWrite.setText(
            _translate("MCSL2_MainWindow", "覆盖"))
        self.ConsoleSettingsWidgetTitleLabel.setText(
            _translate("MCSL2_MainWindow", "终端设置"))
        self.ConsoleOutputEncoding.setText(
            _translate("MCSL2_MainWindow", "控制台输出编码"))
        self.ConsoleOutputEncodingComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "UTF-8（默认）"))
        self.ConsoleOutputEncodingComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "GBK（乱码可尝试）"))
        self.ConsoleInputDecoding.setText(
            _translate("MCSL2_MainWindow", "发送指令编码"))
        self.ConsoleInputDecodingComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "与输出相同"))
        self.ConsoleInputDecodingComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "UTF-8"))
        self.ConsoleInputDecodingComboBox.setItemText(
        ...
        self.UISettingsWidgetTitleLabel.setText(
            _translate("MCSL2_MainWindow", "界面设置"))
        self.TransparentSetting.setText(
            _translate("MCSL2_MainWindow", "背景透明度"))
        self.DarkMode.setText(_translate("MCSL2_MainWindow", "主题模式"))
        self.DarkModeComboBox.setItemText(
            0, _translate("MCSL2_MainWindow", "浅色"))
        self.DarkModeComboBox.setItemText(
            1, _translate("MCSL2_MainWindow", "深色"))
        self.DarkModeComboBox.setItemText(
            2, _translate("MCSL2_MainWindow", "跟随系统"))
        self.TitleBarInsteadOfmacOS.setText(
            _translate("MCSL2_MainWindow", "使用标题栏而不是类macOS样式"))
        self.TransparentPercentNum.setText(
            _translate("MCSL2_MainWindow", "--%"))
        self.AlwaysRunAsAdministrator.setText(
            _translate("MCSL2_MainWindow", "总以管理员身份运行"))
        self.SoftwareSettingsWidgetTitleLabel.setText(
            _translate("MCSL2_MainWindow", "软件设置"))
        self.StartOnStartup.setText(_translate("MCSL2_MainWindow", "开机自动启动"))
        self.UpdaterWidgetTitleLabel.setText(
            _translate("MCSL2_MainWindow", "软件更新"))
        self.CurrentVersionLabel.setText(
            _translate("MCSL2_MainWindow", "当前版本："))
        self.LastUpdateTime.setText(_translate(
            "MCSL2_MainWindow", "最后一次检查更新时间："))
        self.UpdatePushButton.setText(_translate("MCSL2_MainWindow", "检查更新"))
        self.AboutWidgetTitleLabel.setText(
            _translate("MCSL2_MainWindow", "关于"))
        ...
        self.OpenSourceCodePushButton.setText(
            _translate("MCSL2_MainWindow", "打开源代码仓库"))
        self.MCSL2_Author_Label_1.setText(
        ...
        self.SystemReportPushButton.setText(
            _translate("MCSL2_MainWindow", "系统报告"))
        self.Choose_Server_Label.setText(
            _translate("MCSL2_MainWindow", "选择服务器"))
        self.Choose_Java_Label.setText(
            _translate("MCSL2_MainWindow", "选择Java"))
        self.Choose_Java_Back_PushButton.setText(
            _translate("MCSL2_MainWindow", "返回"))
        self.Update_Label.setText(_translate("MCSL2_MainWindow", "程序更新"))
        self.Update_Tip1_Label.setText(_translate(
            "MCSL2_MainWindow", "MCSL 2发布新版本啦！你想更新吗？"))
        self.DoNotUpdate_PushButton.setText(
            _translate("MCSL2_MainWindow", "丑拒"))
        ...
        self.MCSL2_Title_Label_R.setText(
            _translate("MCSL2_MainWindow", "MCSL 2"))
