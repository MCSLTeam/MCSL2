...
class MCSM8(QWidget):
    def __init__(self):
        ...
        self.MCSM8Title.setText(self.tr("导入 MCSManager 8 的服务器"))
        self.MCSM8ImportTitle.setText(self.tr("1. 选择 MCSM8 运行目录"))
        self.MCSM8ImportStatusText.setText(self.tr("[状态文本]"))
        self.MCSM8ImportArchives.setText(self.tr("选择文件夹"))
        self.MCSM8SelectServerStatusText.setText(self.tr("[状态文本]"))
        self.MCSM8SelectServerTitle.setText(self.tr("2.选择需要导入的服务器"))
        self.MCSM8ValidateArgsJavaListPushBtn.setText(self.tr("Java列表"))
        self.MCSM8ValidateArgsAutoDetectJavaPrimaryPushBtn.setText(self.tr("自动查找Java"))
        self.MCSM8ValidateArgsManuallyAddJavaPrimaryPushBtn.setText(self.tr("手动导入"))
        self.MCSM8ValidateArgsDownloadJavaPrimaryPushBtn.setText(self.tr("下载Java"))
        self.MCSM8ValidateArgsJavaSubtitleLabel.setText(self.tr("Java:"))
        self.MCSM8ValidateArgsOutputDeEncodingLabel.setText(self.tr("控制台输出编码（优先级高于全局设置）"))
        self.MCSM8ValidateArgsDeEncodingSubtitleLabel.setText(self.tr("编码设置："))
        self.MCSM8ValidateArgsInputDeEncodingLabel.setText(self.tr("指令输入编码（优先级高于全局设置）"))
        self.MCSM8ValidateArgsJVMArgPlainTextEdit.setPlaceholderText(self.tr("可选，用一个空格分组"))
        self.MCSM8ValidateArgsJVMArgSubtitleLabel.setText(self.tr("JVM参数："))
        self.MCSM8ValidateArgsDownloadCorePrimaryPushBtn.setText(self.tr("下载核心"))
        self.MCSM8ValidateArgsCoreSubtitleLabel.setText(self.tr("核心："))
        self.MCSM8ValidateArgsManuallyAddCorePrimaryPushBtn.setText(self.tr("重新导入"))
        self.MCSM8ValidateArgsMemSubtitleLabel.setText(self.tr("内存:"))
        self.MCSM8ValidateArgsToSymbol.setText(self.tr("~"))
        self.MCSM8ValidateArgsTitle.setText(self.tr("3. 确认参数"))
        self.MCSM8SaveTitle.setText(self.tr("4. 完成导入"))
        self.MCSM8SaveServerNameLineEdit.setPlaceholderText(self.tr("设置服务器昵称，不能包含非法字符"))
        self.MCSM8SaveServerPrimaryPushBtn.setText(self.tr("导入！"))
