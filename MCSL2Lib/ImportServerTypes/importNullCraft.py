...
class NullCraft(QWidget):
    def __init__(self):
        ...
        self.NullCraftImportTitle.setText(self.tr("1. 选择灵工艺开服器主程序"))
        self.NullCraftImportStatusText.setText(self.tr("[状态文本]"))
        self.NullCraftImportArchives.setText(self.tr("选择主程序"))
        self.NullCraftValidateArgsJavaListPushBtn.setText(self.tr("Java列表"))
        self.NullCraftValidateArgsAutoDetectJavaPrimaryPushBtn.setText(self.tr("自动查找Java"))
        self.NullCraftValidateArgsManuallyAddJavaPrimaryPushBtn.setText(self.tr("手动导入"))
        self.NullCraftValidateArgsDownloadJavaPrimaryPushBtn.setText(self.tr("下载Java"))
        self.NullCraftValidateArgsJavaSubtitleLabel.setText(self.tr("Java:"))
        self.NullCraftValidateArgsOutputDeEncodingLabel.setText(self.tr("控制台输出编码（优先级高于全局设置）"))
        self.NullCraftValidateArgsDeEncodingSubtitleLabel.setText(self.tr("编码设置："))
        self.NullCraftValidateArgsInputDeEncodingLabel.setText(self.tr("指令输入编码（优先级高于全局设置）"))
        self.NullCraftValidateArgsJVMArgPlainTextEdit.setPlaceholderText(self.tr("可选，用一个空格分组"))
        self.NullCraftValidateArgsJVMArgSubtitleLabel.setText(self.tr("JVM参数："))
        self.NullCraftValidateArgsDownloadCorePrimaryPushBtn.setText(self.tr("下载核心"))
        self.NullCraftValidateArgsCoreSubtitleLabel.setText(self.tr("核心："))
        self.NullCraftValidateArgsManuallyAddCorePrimaryPushBtn.setText(self.tr("重新导入"))
        self.NullCraftValidateArgsMemSubtitleLabel.setText(self.tr("内存:"))
        self.NullCraftValidateArgsToSymbol.setText(self.tr("~"))
        self.NullCraftValidateArgsTitle.setText(self.tr("2. 确认参数"))
        self.NullCraftSaveTitle.setText(self.tr("3. 完成导入"))
        self.NullCraftSaveServerNameLineEdit.setPlaceholderText(self.tr("设置服务器昵称，不能包含非法字符"))
        self.NullCraftSaveServerPrimaryPushBtn.setText(self.tr("导入！"))
        self.NullCraftTitle.setText(self.tr("导入 灵工艺我的世界「轻」开服器 的服务器"))
