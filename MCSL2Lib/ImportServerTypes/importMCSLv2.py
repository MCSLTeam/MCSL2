...
class MCSLv2(QWidget):
    def __init__(self):
        ...
        self.MCSLv2Title.setText(self.tr("导入 MCSL 2的服务器"))
        self.MCSLv2ImportStatusText.setText(self.tr("[状态文本]"))
        self.MCSLv2ImportTitle.setText(self.tr("1. 选择MCSL 2生成的MCSL2ServerConfig.json"))
        self.MCSLv2ImportArchives.setText(self.tr("选择配置文件"))
        self.MCSLv2ValidateArgsAutoDetectJavaPrimaryPushBtn.setText(self.tr("自动查找Java"))
        self.MCSLv2ValidateArgsJavaSubtitleLabel.setText("Java:")
        self.MCSLv2ValidateArgsJavaListPushBtn.setText(self.tr("Java列表"))
        self.MCSLv2ValidateArgsManuallyAddJavaPrimaryPushBtn.setText(self.tr("手动导入"))
        self.MCSLv2ValidateArgsDownloadJavaPrimaryPushBtn.setText(self.tr("下载Java"))
        self.MCSLv2ValidateArgsOutputDeEncodingLabel.setText(self.tr("控制台输出编码（优先级高于全局设置）"))
        self.MCSLv2ValidateArgsDeEncodingSubtitleLabel.setText(self.tr("编码设置："))
        self.MCSLv2ValidateArgsInputDeEncodingLabel.setText(self.tr("指令输入编码（优先级高于全局设置）"))
        self.MCSLv2ValidateArgsJVMArgPlainTextEdit.setPlaceholderText(self.tr("可选，用一个空格分组"))
        self.MCSLv2ValidateArgsJVMArgSubtitleLabel.setText(self.tr("JVM参数："))
        self.MCSLv2ValidateArgsMemSubtitleLabel.setText(self.tr("内存:"))
        self.MCSLv2ValidateArgsToSymbol.setText("~")
        self.MCSLv2ValidateArgsTitle.setText(self.tr("2. 确认参数"))
        self.MCSLv2ValidateArgsDownloadCorePrimaryPushBtn.setText(self.tr("下载核心"))
        self.MCSLv2ValidateArgsCoreSubtitleLabel.setText(self.tr("核心："))
        self.MCSLv2ValidateArgsManuallyAddCorePrimaryPushBtn.setText(self.tr("重新导入"))
        self.MCSLv2SaveTitle.setText(self.tr("3. 完成导入"))
        self.MCSLv2SaveServerNameLineEdit.setPlaceholderText(self.tr("设置服务器昵称，不能包含非法字符"))
        self.MCSLv2SaveServerPrimaryPushBtn.setText(self.tr("导入！"))
