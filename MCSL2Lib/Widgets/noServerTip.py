...
class NoServerWidget(QWidget):
    def __init__(self):
        ...
        spacerItem = QSpacerItem(261, 69, QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        spacerItem2 = QSpacerItem(50, 15, QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        spacerItem3 = QSpacerItem(50, 15, QSizePolicy.Expanding, QSizePolicy.Expanding)
