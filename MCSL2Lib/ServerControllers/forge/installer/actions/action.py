...
class Action:
    ...
    def __init__(self, profile: InstallV1, monitor: ProgressCallback, installer: Path, isClient: bool):
        ...
        self.version = Util.loadVersion(
            DownloadUtils.readFileInZip(self.installerDataBuf, Path(profile.getJson())).decode("utf-8")
        )
